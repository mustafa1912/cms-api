...
class serviceController extends Controller
{
    ...
    {
        $Service =Service::where('softDelete',0)->get();
...
//                $store_arr['logo'] = $request->logo->store('public/Service/logo');
//            }

            Service::create($store_arr);
...
//            }
            ...
            Service::where('id', $id)->update($store_arr);
