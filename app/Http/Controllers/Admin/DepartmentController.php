...
class DepartmentController extends Controller
{
    ...
    {
        $department =Department::where('softDelete',0)->get();
...
//                $store_arr['logo'] = $request->logo->store('public/department/logo');
//            }

            Department::create($store_arr);
...
//            }
            ...
            Department::where('id', $id)->update($store_arr);
